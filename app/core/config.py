...
class Settings(BaseSettings):
    ...
    global_request_burst_limit: int = Field(default=10, ge=1)
    global_request_burst_window_seconds: int = Field(default=2, ge=1)
    ...
    account_target_limit_per_minute: int = Field(default=295, ge=1)
    account_target_min_limit_per_minute: int = Field(default=260, ge=1)
    account_target_decrease_step_per_minute: int = Field(default=10, ge=1)
    account_target_ramp_idle_seconds: float = Field(default=300.0, ge=1)
    account_min_limit_per_minute: int = Field(default=60, ge=1)
    account_limit_decrease_step_per_minute: int = Field(default=30, ge=1)
    account_limit_ramp_step_per_minute: int = Field(default=20, ge=1)
    account_limit_ramp_idle_seconds: float = Field(default=180.0, ge=1)
